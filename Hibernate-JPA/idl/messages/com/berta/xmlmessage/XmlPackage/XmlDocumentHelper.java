...
public final class XmlDocumentHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(com.berta.xmlmessage.XmlPackage.XmlDocumentHelper.id(), "XmlDocument",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(10))));
		}
		return _type;
	}
	...
	{
		return "IDL:com/berta/xmlmessage/Xml/XmlDocument:1.0";
	}
